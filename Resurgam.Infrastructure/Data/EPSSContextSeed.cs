...
namespace Resurgam.Infrastructure.Data
{
    public class ResurgamContextSeed
    {
        ...
        static IEnumerable<Topic> GetPreconfiguredTopics()
        {
            ...
            var document1 = new Topic() { TopicId = new Guid(444, 0, 0, new byte[8]), Name = "Document Topic", ProjectId = _projectId1, Description = "Document Desc", DefaultCategoryId = new Guid(3, 0, 0, new byte[8]), TopicTypeId = TopicTypes.DocumentTopic.Id, DocumentName = "Wireframes.pptx" };
